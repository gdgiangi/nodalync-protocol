...
pub fn relationships_from_wikilinks(
    entity_label: &str,
    content: &str,
) -> Vec<VaultRelationship> {
...
impl FallbackNER {
    pub fn new() -> Result<Self> {
        ...
        let blocklist_words = vec![
            ...
            "About", "Above", "According", "Action", "Active", "After", "Again", "Against",
            "All", "Also", "Always", "Amount", "And", "Another", "Any", "Application",
            "Approach", "Are", "Around", "Available", "Back", "Based", "Basic", "Because",
            "Been", "Before", "Being", "Below", "Best", "Better", "Between", "Both",
            "Build", "Building", "Built", "But", "Can", "Case", "Change", "Clear",
            "Close", "Code", "Come", "Common", "Complete", "Complex", "Connection",
            "Consider", "Context", "Control", "Core", "Could", "Create", "Current",
            "Custom", "Data", "Day", "Days", "Decision", "Default", "Define", "Deploy",
            "Design", "Development", "Different", "Direct", "Does", "Done", "Down",
            "During", "Each", "Early", "Easy", "Effect", "Either", "Enable", "End",
            "Ensure", "Error", "Even", "Event", "Every", "Example", "Execute",
            "Existing", "Expect", "Experience", "External", "Fact", "False", "Feature",
            "Field", "File", "Final", "Find", "First", "Focus", "Follow", "For",
            "Force", "Form", "From", "Full", "Function", "Future", "General", "Get",
            "Give", "Global", "Going", "Good", "Great", "Group", "Growth", "Had",
            "Handle", "Has", "Have", "Help", "Here", "High", "Hold", "How",
            "However", "Idea", "Impact", "Implement", "Important", "Include", "Info",
            "Initial", "Input", "Inside", "Instead", "Internal", "Into", "Issue",
            "Item", "Its", "Just", "Keep", "Key", "Kind", "Know", "Known",
            "Large", "Last", "Late", "Launch", "Lead", "Left", "Less", "Let",
            "Level", "Like", "Line", "Link", "List", "Live", "Local", "Long",
            "Look", "Low", "Made", "Main", "Major", "Make", "Many", "Match",
            "Matter", "May", "Mean", "Method", "Might", "Model", "More", "Most",
            "Move", "Much", "Must", "Name", "Need", "New", "Next", "None",
            "Normal", "Not", "Note", "Nothing", "Now", "Number", "Off", "Old",
            "Once", "One", "Only", "Open", "Option", "Order", "Other", "Out",
            "Output", "Over", "Overview", "Own", "Part", "Path", "Pattern", "Per",
            "Place", "Plan", "Point", "Post", "Potential", "Power", "Present",
            "Previous", "Primary", "Problem", "Process", "Product", "Project",
            "Proper", "Provide", "Public", "Pull", "Purpose", "Push", "Put",
            "Quality", "Query", "Question", "Quick", "Quite", "Range", "Rate",
            "Read", "Ready", "Real", "Really", "Reason", "Recent", "Record",
            "Related", "Release", "Remove", "Report", "Request", "Required",
            "Response", "Rest", "Result", "Return", "Review", "Right", "Role",
            "Run", "Running", "Safe", "Same", "Save", "Scale", "Scope", "Second",
            "Section", "See", "Seems", "Send", "Serialization", "Server", "Service",
            "Session", "Set", "Setup", "Should", "Show", "Side", "Simple", "Since",
            "Single", "Size", "Small", "Some", "Something", "Source", "Space",
            "Specific", "Stage", "Standard", "Start", "State", "Status", "Step",
            "Still", "Stop", "Store", "Strategy", "Strong", "Structure", "Style",
            "Subject", "Success", "Such", "Support", "Sure", "System", "Table",
            "Take", "Target", "Task", "Team", "Tech", "Tell", "Term", "Test",
            "Than", "That", "The", "Their", "Them", "Then", "There", "These",
            "They", "Thing", "Think", "This", "Those", "Though", "Through", "Time",
            "Today", "Together", "Too", "Tool", "Top", "Total", "Track", "True",
            "Try", "Turn", "Type", "Under", "Until", "Update", "Upon", "Use",
            "Used", "User", "Using", "Value", "Version", "Very", "View", "Want",
            "Was", "Way", "Well", "Were", "What", "When", "Where", "Whether",
            "Which", "While", "Who", "Whole", "Why", "Will", "With", "Within",
            "Without", "Work", "Working", "Would", "Write", "Year", "Yet", "You",
            "Your",
            // Programming/tech terms
            "Abstract", "Algorithm", "Array", "Binary", "Boolean", "Buffer", "Cache",
            "Class", "Client", "Command", "Component", "Config", "Configuration",
            "Const", "Constructor", "Container", "Crypto", "Database", "Debug",
            "Enum", "Export", "Filter", "Format", "Framework", "Handler", "Hash",
            "Header", "Heap", "Import", "Index", "Instance", "Interface", "Iterator",
            "Layer", "Library", "Macro", "Manager", "Memory", "Message", "Middleware",
            "Module", "Mutex", "Namespace", "Network", "Object", "Package", "Parser",
            "Plugin", "Pointer", "Protocol", "Proxy", "Queue", "Reference", "Registry",
            "Render", "Repository", "Resolution", "Resource", "Router", "Runtime",
            "Schema", "Script", "Selector", "Sequence", "Socket", "Stack", "Stream",
            "String", "Struct", "Syntax", "Template", "Thread", "Timeout", "Token",
            "Trait", "Transaction", "Transform", "Trigger", "Tuple", "Validator",
            "Variable", "Vector", "Vendor", "Virtual", "Wrapper",
        ];

        let blocklist: HashSet<String> = blocklist_words
            .iter()
            .map(|w| w.to_lowercase())
            .collect();

        Ok(Self { person_re, blocklist })
    }
...
Some body text."#;
        ...
        assert!(related.contains(&"\"[[Example Organization]]\"".to_string()) || related.contains(&"[[Example Organization]]".to_string()));
    }
...
"#;
    ...
    fn test_strip_wikilink() {
        assert_eq!(strip_wikilink("\"[[Example Organization]]\""), Some("Example Organization".to_string()));
    ...
    fn test_relationships_from_frontmatter() {
        ...
        assert!(rels.iter().any(|r| r.predicate == "worksFor" && r.object_label == "Example Organization"));
    }
