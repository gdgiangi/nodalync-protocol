...
Some body text."#;
        ...
        assert!(related.contains(&"\"[[Leedana]]\"".to_string()) || related.contains(&"[[Leedana]]".to_string()));
    }
...
"#;
    ...
    fn test_strip_wikilink() {
        assert_eq!(strip_wikilink("\"[[Leedana]]\""), Some("Leedana".to_string()));
    ...
    fn test_relationships_from_frontmatter() {
        ...
        assert!(rels.iter().any(|r| r.predicate == "worksFor" && r.object_label == "Leedana"));
    }
